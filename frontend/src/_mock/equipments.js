...
export const equipments = [...Array(24)].map((_, index) => {
  ...
  return {
    ...
    colors:
      (setIndex === 1 && EQUIPMENT_COLOR.slice(0, 2)) ||
      (setIndex === 2 && EQUIPMENT_COLOR.slice(1, 3)) ||
      (setIndex === 3 && EQUIPMENT_COLOR.slice(2, 4)) ||
      (setIndex === 4 && EQUIPMENT_COLOR.slice(3, 6)) ||
      (setIndex === 23 && EQUIPMENT_COLOR.slice(4, 6)) ||
      (setIndex === 24 && EQUIPMENT_COLOR.slice(5, 6)) ||
      EQUIPMENT_COLOR,
